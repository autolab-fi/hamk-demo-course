...
Hello and welcome to sandbox-draw mode, where you can test your code. Additionally, you can execute Verify and a blue trail will be left behind the robot for 60 seconds.
